...
class NgsimDataset(Dataset):
    ...
    def __init__(self, mat_file, t_h=30, t_f=50, d_s=2, enc_size = 64, grid_size = (13,3)):
        ...
        self.t_h = t_h  # length of track history, 3 seconds with a sampling rate of 10 Hz
        self.t_f = t_f  # length of predicted trajectory, 5 seconds with a sampling rate of 10 Hz
